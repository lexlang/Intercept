...
public class ProxyServer {
  ...
  public ProxyServer serverConfig(HttpProxyServerConfig serverConfig) {
    this.serverConfig = serverConfig;
    return this;
  }

  public ProxyServer proxyInterceptInitializer(
      HttpProxyInterceptInitializer proxyInterceptInitializer) {
    this.proxyInterceptInitializer = proxyInterceptInitializer;
    return this;
  }

  public ProxyServer httpProxyExceptionHandle(
  ...
  public ProxyServer caCertFactory(HttpProxyCACertFactory caCertFactory) {
